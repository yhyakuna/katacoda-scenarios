...
```
If the identity, `bob`, is defined in LDAP user account, you need the LDAP auth accessor ID.  In addition, if the identity, `bsmith is defined in Okta, you would need the Okta accessor ID as well. 
