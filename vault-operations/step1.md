...
> Enter the following command into the terminal, or click on the command to automatically copy it into the terminal and execute it to downloads the `0.10.1` of the Vault binary for Linux.
